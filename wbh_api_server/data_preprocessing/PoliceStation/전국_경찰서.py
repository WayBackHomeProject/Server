...
# 엑셀 파일 경로
excel_file_path = "Z:/WayBackHome/DataSet/전국경찰서좌표.xlsx"
...
# 기존 테이블이 존재하면 삭제합니다.
drop_table_query = "DROP TABLE IF EXISTS data_api_policeStation"
cursor.execute(drop_table_query)

# 새로운 테이블을 생성합니다.
create_table_query = """
CREATE TABLE data_api_policeStation (
...
# 데이터 삽입 쿼리
insert_query = """
INSERT INTO data_api_policeStation (
    number,
    sido,
    policestation,
    department,
